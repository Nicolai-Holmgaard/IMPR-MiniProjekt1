...
Filen [test/test_calculator.c](test/test_calculator.c) indeholder et eksempel af en unit test skrevet med testing frameworket [mtest](https://github.com/MortenSchou/mtest). 
Her skal du selv tilføje flere unit test af funktionen `do_next_op`. Jeg har desuden skrevet regne-eksemplet ovenfor som en test-case i [test/test_calculator.c](test/test_calculator.c).
